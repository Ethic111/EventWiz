          ...
          <footer class="footer">
            ...
            <div class="footer-content">
              ...
              <div class="footer-social-links">
                ...
                <Link class="footer-social-link linkedin" to="https://www.linkedin.com/in/radhikadesai583/" target="_blank">
                ...
                <Link class="footer-social-link github" to="https://github.com/Ethic111/EventWiz" target="_blank">
              ...
              <div class="footer-copyright-wrapper">
                <p class="footer-copyright-text">
                  <Link class="footer-copyright-link" to="/" target="_self">
                    {" "}
                    ©2024. | Designed By: Radhika Desai. | All rights reserved.{" "}
                  </Link>
                </p>
              </div>
            </div>
