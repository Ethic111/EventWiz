...
import "../../css/UserEvent/Alleventspage.css";
import api from "../api";
import {
  FaArrowCircleRight,
  FaArrowCircleLeft,
              ...
              <div className="row">
                {details && details.length ? (
                  details.map((post) => (
                    ...
                    >
                      <div class="usereventsmain">
                        <ul class="usereventscards">
                          <li class="usereventscards_item">
                            <div class="usereventscard">
                              <div class="usereventscard_image">
                                <img
                              ...
                              <div class="usereventscard_content">
                                <h2
                                  class="usereventscard_title"
                                  onClick={() => handlepostdetails(post)}
                                  style={{ cursor: "pointer" }}
                                >
                                  {post.event_title}
                                </h2>
                                <div class="usereventscard_text">
                                  <p class="cardptag">
